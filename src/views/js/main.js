...
var resizePizzas = function(size) {
  ...
  var pizzaSelect = document.getElementById("pizzaSize").innerHTML;
  // Changes the value for the size of the pizza above the slider
 
  /*
    Combined the changeSliderLabel and sizeSwitcher to reduce the number of functions
    and thus calculations.
    I also removed all dx calculations to, again, reduce number of total calculations
  */
  ...
  /*
    moved the call to the DOM outside the for loop, changed the unit from pixel to %, as well as used a
    constant number for pizzaLength to reduce calculations.
  */
...
function updatePositions() {
  ...
  /* 
    Again I moved all of the calls to the DOM outside the for loop and created a second for loop
    to update phaseArray. I also moved most of the calculations which don't require the i or j
    variables from the for loop into a variable outside the loops.
  */
...
/*
  the requestAnimationFrame is used to help reduce the paint and composite times while
  updating the moving pizza locations.
*/
...
/*
  Moved all the calls to the DOM and all variables outside the fo loop. I also included
  backfaceVisibility, transforms Z and 3d in an attempt to increase framerate.
*/
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var pizzas = 48;
  var movingPi = document.getElementById("movingPizzas1");
  var elem;
